...
// ✨ NUEVO - Guardar URL de Cloudinary (upload directo desde frontend)
router.post("/obras/:id/imagenes/url", verifyFirebaseToken, requireAdmin, saveImageUrl); // Solo admin
// ⚠️ ORIGINAL - Upload vía backend con Multer (requiere Railway)

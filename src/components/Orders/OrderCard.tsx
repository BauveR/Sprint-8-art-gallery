          ...
          <div className="flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground tracking-wide mt-1">{order.autor}</p>
              </div>
              ...
              {showTracking && order.numero_seguimiento && (
                <div
                  className={`${estadoConfig.bgColor} border ${
                    estadoConfig.badgeClass.split(" ").find((c) => c.includes("border-"))
            ...
            <div className="mt-4 pt-4 border-t border-foreground/10">
              <p className="text-2xl font-light tracking-wide">
                ${formatPrice(order.precio_salida || 0)}
              </p>
            </div>
          </div>
        </div>

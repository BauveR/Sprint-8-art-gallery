-- Drop and recreate obras_estado_actual VIEW to include tienda_online logic
...
SELECT
  ...
  o.comprador_email,
  o.fecha_compra,
  -- Calcular ubicación considerando si la tienda es online
  (CASE
...
LEFT JOIN (
  -- Última tienda activa por obra (incluyendo es_online)
